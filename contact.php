  ...
  <section class="container my-5">
    <div class="row">
      <div class="col-md-6 mb-4">
        ...
        <form method="POST" action="src/message.php">
          <div class="mb-3">
...
if (isset($_SESSION['success'])) {
    ...
    unset($_SESSION['success']); // on l'efface pour ne pas qu'il reste après un refresh
}

// Message d'erreur
if (isset($_GET['error']) && $_GET['error'] === 'notfound') {
    echo "<p style='color:red; font-weight:bold;'>Une erreur est survenue lors de l'envoi du formulaire.</p>";
}
?>
